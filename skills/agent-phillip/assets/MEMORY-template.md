...
_Keep under 200 lines. Raw session notes go in `sessions/YYYY-MM-DD.md` (not here). Prune what's stale. Every token here loads every session — make each one count._
