...
#!/usr/bin/env python3
"""
First Breath — Deterministic sanctum scaffolding for Marc (Analytics).
"""
...
SKILL_NAME = "agent-marc-analytics"
...
def main():
    parser = argparse.ArgumentParser(
        description="First Breath — Create sanctum scaffolding for agent-marc-analytics"
    )
    ...
    (sanctum_path / "CAPABILITIES.md").write_text(generate_capabilities_md(capabilities))
